            ...
            for (int v_wg_id_47 = get_group_id(0); (v_wg_id_47 < 3); v_wg_id_47 = (v_wg_id_47 + get_num_groups(0))){
                ...
                if ((get_local_id(1) < 1)){
                    ...
                    for (int v_l_id_49 = get_local_id(0); (v_l_id_49 < 36); v_l_id_49 = (v_l_id_49 + get_local_size(0))){
                        v__56_0 = id(v__52[(v_wg_id_47 + v_l_id_48)]); 
                        // reduce_seq
                        for (int v_i_50 = 0; (v_i_50 < 18); v_i_50 = (1 + v_i_50)){
                            v__56_0 = add(v__56_0, v__53[(v_i_50 + (18 * v_l_id_49) + (648 * v_l_id_48) + (1944 * v_wg_id_46) + (648 * v_wg_id_47))]); 
                        }
                        // end reduce_seq
                        // map_seq
                        // unroll
                        v__60[(v_l_id_49 + (36 * v_wg_id_47) + (36 * v_l_id_48) + (108 * v_wg_id_46))] = id(v__56_0); 
                        // end unroll
                        // end map_seq
                    }
                }
