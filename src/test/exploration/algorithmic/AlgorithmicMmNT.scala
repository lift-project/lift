...
class AlgorithmicMmNT {
  ...
  def tilingWithTwoDBlocking(): Unit = {
    ...
    checkExists(twoDGold, tilingWith2DBlockingSeq, rewrittenLambdas)
  ...
  def plainTiling(): Unit = {
    ...
    checkExists(plainTilingGold, plainTilingSeq, rewrittenLambdas)
  ...
  def tilingWithOneDBlocking(): Unit = {
    ...
    checkExists(oneDGold, tilingWith1DBlockingSeq, rewrittenLambdas)
