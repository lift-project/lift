...
class TestMemoryMappingRewrite {
  ...
  def mmKepler(): Unit = {
    ...
    val keplerGold = fun(ArrayTypeWSWC(ArrayTypeWSWC(Float, M), K), ArrayTypeWSWC(ArrayTypeWSWC(Float, N), K),(p_0, p_1) =>
      FunCall(Join(),
                                              ...
                                              FunCall(MapSeq(fun((p_25) =>
                                                FunCall(MapSeq(fun((p_26) =>
                                                  ...
                                                  FunCall(Zip(2),
                                                    ...
                                                    FunCall(Get(1), p_24))))),
                                                FunCall(Zip(2), p_21,
                                                  FunCall(Get(0), p_24)))), p_23)),
                                            FunCall(toPrivate(fun((p_27) =>
                                              FunCall(Tuple(2),
                                                FunCall(MapSeq(fun((p_28) =>
                                                  FunCall(idfloat, p_28))),
                                                  FunCall(Get(0), p_27)),
                                                FunCall(MapSeq(fun((p_29) =>
                                                  FunCall(idfloat, p_29))),
                                                  FunCall(Get(1), p_27))))), p_22)))),
                                          FunCall(Get(0), p_19),
                                          FunCall(Zip(2),
                                            FunCall(Transpose(),
                                              FunCall(Get(1), p_18)),
                                    ...
                                    FunCall(MapLcl(1)(fun((p_31) =>
                                      FunCall(Tuple(2),
                                        ...
                                        FunCall(MapLcl(0)(fun((p_33) =>
                                          FunCall(idfloat, p_33))),
                                          FunCall(Get(1), p_31))))),
                                      FunCall(Zip(2),
                                        FunCall(Get(0), p_30),
                                        FunCall(Get(1), p_30)))))), p_16))), p_15))),
                            FunCall(MapLcl(1)(fun((p_34) =>
                              FunCall(MapLcl(0)(fun((p_35) =>
                                FunCall(MapSeq(fun((p_36) =>
                                  FunCall(MapSeq(fun((p_37) =>
                                    FunCall(idfloat, p_37))), p_36))), p_35))), p_34))), Value("0.0f", ArrayTypeWSWC(ArrayTypeWSWC(ArrayTypeWSWC(ArrayTypeWSWC(Float, v__4), v__5), v__3 * 1 /^ v__4), v__6 * 1 /^ v__5))),
  ...
  def mmHawaii(): Unit = {
    ...
    val hawaiiGold = fun(ArrayTypeWSWC(ArrayTypeWSWC(Float, M), K), ArrayTypeWSWC(ArrayTypeWSWC(Float, N), K),(p_0, p_1) =>
      FunCall(Join(),
        FunCall(MapWrg(1)(fun((p_2) =>
          FunCall(TransposeW(),
            FunCall(Join(),
                              ...
                              FunCall(fun((p_17) =>
                                FunCall(MapLcl(1)(fun((p_18) =>
                                            ...
                                            FunCall(fun((p_24) =>
                                              ...
                                              FunCall(toLocal(fun((p_27) =>
                                                FunCall(Tuple(2),
                                                  ...
                                                  FunCall(MapSeq(fun((p_29) =>
                                                    FunCall(idfloat, p_29))),
                                                    FunCall(Get(1), p_27))))), p_23))),
                                            FunCall(toPrivate(fun((p_30) =>
                                              FunCall(Tuple(2),
                                                FunCall(Get(0), p_30),
                                                FunCall(MapSeq(fun((p_31) =>
                                                  FunCall(idfloat, p_31))),
                                                  FunCall(Get(1), p_30))))), p_22)))),
                                          FunCall(Get(0), p_19),
                                          FunCall(Zip(2),
                                            FunCall(Transpose(),
                                              FunCall(Get(1), p_18)),
                                  ...
                                  FunCall(Zip(2), p_14,
                                    FunCall(Split(v__5),
                                      FunCall(Transpose(),
                                        FunCall(Get(0), p_17)))))), p_16)), p_15))),
                            FunCall(MapLcl(1)(fun((p_32) =>
                              FunCall(MapLcl(0)(fun((p_33) =>
                                FunCall(MapSeq(fun((p_34) =>
                                  FunCall(MapSeq(fun((p_35) =>
                                    FunCall(idfloat, p_35))), p_34))), p_33))), p_32))), Value("0.0f", ArrayTypeWSWC(ArrayTypeWSWC(ArrayTypeWSWC(ArrayTypeWSWC(Float, v__4), v__5), v__3 * 1 /^ v__4), v__6 * 1 /^ v__5))),
                            FunCall(Zip(2), p_2, p_3))))))))),
                FunCall(Transpose(),
                  FunCall(Map(fun((p_36) =>
                    ...
                    FunCall(Split(v__7),
                      FunCall(Map(fun((p_37) =>
                        FunCall(Split(v__3), p_37))), p_1))))))))),
          FunCall(Transpose(),
            FunCall(Map(fun((p_38) =>
              FunCall(Transpose(), p_38))),
              FunCall(Split(v__7),
                FunCall(Map(fun((p_39) =>
                  FunCall(Split(v__6), p_39))), p_0)))))))
  ...
  def mmVectorLoads(): Unit = {
    ...
    val vectorLoadsGold = fun(ArrayTypeWSWC(ArrayTypeWSWC(Float, M), K), ArrayTypeWSWC(ArrayTypeWSWC(Float, N), K),(p_0, p_1) =>
      FunCall(Join(),
        FunCall(MapWrg(1)(fun((p_2) =>
          FunCall(TransposeW(),
            FunCall(Join(),
