                              ...
                              FunCall(MapLcl(1)(fun((p_9) =>
                                FunCall(MapLcl(0)(fun((p_10) =>
                                  FunCall(MapSeq(fun((p_11) =>
                                    FunCall(asScalar(),
                                      FunCall(MapSeq(fun((p_12) =>
                                        FunCall(VectorizeUserFun(vectorWidth,add),
                                          toPrivate(mult2)(p_12._0, alpha),
                                          toPrivate(mult2)(p_12._1, beta)
                                        ))),
                                        Zip(FunCall(asVector(vectorWidth), p_11._0), asVector(vectorWidth) $ p_11._1))))),
                                    Zip(p_10._0, Transpose() $ p_10._1)))),
                                  Zip(p_9._0, Split(v__3) o Join() o Gather(ReorderWithStride(v__5/v__3* vectorWidth)) o Split(vectorWidth) o Transpose() $ p_9._1)))),
