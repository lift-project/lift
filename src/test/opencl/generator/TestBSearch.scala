  ...
  @Test def TO_PRIVATE_TEST() : Unit = {
    ...
    val kernel = fun(
        ...
        (array) => {
          ...
          MapSeq(toGlobal(id)) o MapSeq(toPrivate(id)) $ array
          // MapSeq(toGlobal(id)) o Join() o MapSeq(toPrivate(id)) o Split(2) $ array
          // MapSeq(toGlobal(id)) o Join() o MapSeq(MapSeq(toPrivate(id))) o Split(2) $ array
          // MapSeq(id) $ array
        }
    )
