 ...
 ***********************************************************/
  @Test def rodiniaHotspot(): Unit = {
    ...
    */
    ...
    val (output: Array[Float], runtime) = ExecuteOld(16, 16, 1184, 1184, (true, true))(rodinia, heat, power, coeff)
  ...
  ***********************************************************/
  @Test def rodiniaHotspot3D(): Unit = {
    ...
    val (output: Array[Float], runtime) = ExecuteOld(64, 4, 1, 512, 512, 1, (true, true))(stencil, input, weights)
  }
  ...
  @Test def rodiniaHotspot3DOpt1(): Unit = {
    ...
    val (output: Array[Float], runtime) = ExecuteOld(64, 4, 1, 512, 512, 8, (true, true))(stencil, input)
  }
  ...
  @Test def rodiniaHotspot3DLocalMemory(): Unit = {
    ...
    // testing
    val input = Array.tabulate(8, 512, 512) { (i, j, k) => Random.nextFloat() }
    val (output: Array[Float], runtime) = ExecuteOld(64, 4, 1, 512, 512, 1, (true, true))(stencil, input)
  }
  ...
  def RodiniaHotSpot3DWithData(): Unit = {
    ...
    val (output: Array[Float], runtime) = ExecuteOld(2,2,2,2,2,2, (true,true))(source,newLambda, tempInput, powerInput, HotSpotConstants.ce,HotSpotConstants.cw,HotSpotConstants.cn,HotSpotConstants.cs,HotSpotConstants.ct,HotSpotConstants.cb,HotSpotConstants.cc,HotSpotConstants.stepDivCap)
...
//    assertArrayEquals(StencilDataArrays.compareDataHotspot3D, output, 0.1f)
  ...
  def RodiniaSRAD1(): Unit = {
    ...
    val (output: Array[Float], runtime) = ExecuteOld(2, 2, 2, 2, (true, true))(source, newLambda, imageValues2D)
  ...
  def RodiniaSRAD1Consolidated(): Unit = {
    ...
    val (output: Array[Float], runtime) = ExecuteOld(2, 2, 2, 2, (true, true))(source, newLambda, imageValues2D,q0sqr)
  ...
  def RodiniaSRAD2CalculateOnTheFly(): Unit = {
    ...
    val (output: Array[Float], runtime) = ExecuteOld(2, 2, 2, 2, (true, true))(source, newLambda, imageValues2D, coeffValues2D)
    val outputRemixed = output.sliding(Ncols, Ncols).toArray
    val outputRemixed2 = outputRemixed.transpose
  ...
  def RodiniaSRAD2CalculatePullInValues(): Unit = {
    ...
    val (output: Array[Float], runtime) = ExecuteOld(2, 2, 2, 2, (true, true))(source, newLambda, imageValues2D, coeffValues2D, DNValues2D, DSValues2D, DEValues2D, DWValues2D)
    val outputRemixed = output.sliding(Ncols, Ncols).toArray
    val outputRemixed2 = outputRemixed.transpose
