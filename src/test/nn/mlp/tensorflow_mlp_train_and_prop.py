...
layer0_size_start_from = 0 # For continuning an unfinished job
layer0_size_min = 32
layer0_size_max = 1024
layer0_size_step = 32
n_inputs_start_from = 0 # For continuning an unfinished job
n_inputs_min = 32
n_inputs_max = 1900
n_inputs_step = 32
for layer0_size in np.arange(max(layer0_size_start_from, layer0_size_min),
    ...
    for n_inputs in np.arange(n_inputs_start, n_inputs_max, n_inputs_step):
