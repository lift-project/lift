...
package object conv {
  ...
  def configToString(inputShape: Shape, outputShape: Shape,
                     convConfig: nn.conv.Experiment.Config): String = {
    f"inputShape=" + inputShape.toString() + "\n\n" +
      f"outputShape=" + outputShape.toString() + "\n\n" +
      f"convConfig=" + convConfig.toString() + "\n"
  }
