...
import ir.ast._
import ir.ast.debug.{PrintComment, PrintType}
import lift.arithmetic.SizeVar
import nn._
import nn.conv.{ConvDatasets, SlidingWindowConfig}
import opencl.ir._
...
/**
  ...
  * @param globalSize
  */
case class Conv_0_SeqInChs(liftFProp: FunDecl,
...
object Conv_0_SeqInChs {
  ...
  def apply(iP: InitParameters): Conv_0_SeqInChs = {
    /**
    ...
    localSize(locC) = scala.math.pow((inputTiling.size - (kernelSliding.size - 1)) / kernelSliding.stride, 2).toInt
