...
class TestRules {
  ...
  def mapTransposePromotion(): Unit = {
    ...
    val f = fun(
      ArrayType(ArrayType(ArrayType(ArrayType(Float, M), N), K), O),
  ...
  def slidePromotion(): Unit = {
    ...
    val f = fun(
      ArrayType(ArrayType(ArrayType(Float, M), N), K),
  ...
  def transposeSwap(): Unit = {
    ...
    val f = fun(
      ArrayType(ArrayType(ArrayType(ArrayType(ArrayType(Float, M), N), K), O), P),
