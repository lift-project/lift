...
class TestDerivingTiling {
  ...
  def mapsOnly(): Unit = {
    ...
    val (output: Array[Float], _) = ExecuteOld(1, nSize)(f, matrix)
    ...
    val (output1: Array[Float], _) = ExecuteOld(1, nSize)(f1, matrix)
    ...
    val (output2: Array[Float], _) = ExecuteOld(1, nSize)(f2, matrix)
    ...
    val (output3: Array[Float], _) = ExecuteOld(1, nSize)(f3, matrix)
    ...
    val (output4: Array[Float], _) = ExecuteOld(1, nSize)(f4, matrix)
    ...
    val (output5: Array[Float], _) = ExecuteOld(1, nSize)(f5, matrix)
    ...
    val (output6: Array[Float], _) = ExecuteOld(1, nSize)(f6, matrix)
  ...
  def mmSquareTiles(): Unit = {
    ...
    val (output20: Array[Float], _) = ExecuteOld(1, mSize)(f20, matrixA, transposedMatrixB)
    ...
    val (output21: Array[Float], _) = ExecuteOld(1, mSize)(f21, matrixA, transposedMatrixB)
    ...
    val (output22: Array[Float], _) = ExecuteOld(1, mSize)(f22, matrixA, transposedMatrixB)
    ...
    val (output23: Array[Float], _) = ExecuteOld(1, mSize)(f23, matrixA, transposedMatrixB)
    ...
    val (output24: Array[Float], _) = ExecuteOld(1, mSize)(f24, matrixA, transposedMatrixB)
    ...
    val (output25: Array[Float], _) = ExecuteOld(1, mSize)(f25, matrixA, transposedMatrixB)
    ...
    val (output26: Array[Float], _) = ExecuteOld(1, mSize)(f26, matrixA, transposedMatrixB)
    ...
    val (output27: Array[Float], _) = ExecuteOld(1, mSize)(f27, matrixA, transposedMatrixB)
    ...
    val (output28: Array[Float], _) = ExecuteOld(1, mSize)(f28, matrixA, transposedMatrixB)
    ...
    val (output29: Array[Float], _) = ExecuteOld(1, mSize)(f29, matrixA, transposedMatrixB)
    ...
    val (output30: Array[Float], _) = ExecuteOld(1, mSize)(f30, matrixA, transposedMatrixB)
    ...
    val (output31: Array[Float], _) = ExecuteOld(1, mSize)(f31, matrixA, transposedMatrixB)
    ...
    val (output32: Array[Float], _) = ExecuteOld(1, mSize)(f32, matrixA, transposedMatrixB)
    ...
    val (output33: Array[Float], _) = ExecuteOld(1, mSize)(f33, matrixA, transposedMatrixB)
    ...
    val (output34: Array[Float], _) = ExecuteOld(1, mSize)(f34, matrixA, transposedMatrixB)
    ...
    val (output35: Array[Float], _) = ExecuteOld(1, mSize)(f35, matrixA, transposedMatrixB)
    ...
    val (output36: Array[Float], _) = ExecuteOld(1, mSize)(f36, matrixA, transposedMatrixB)
    ...
    val (output37: Array[Float], _) = ExecuteOld(1, mSize)(f37, matrixA, transposedMatrixB)
    ...
    val (output38: Array[Float], _) = ExecuteOld(1, mSize)(f38, matrixA, transposedMatrixB)
