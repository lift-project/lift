...
object JavaFXRenderer {
  ...
  /**
    * Method in wich the scaling of the graphics can be adjusted. It was not used in the end.
    * The scaling was set to a fixed value to ensure readability.
    * @param primitives All primitives.
    * @param ctx The current context.
    * @return The context with adjusted scaling.
    */
