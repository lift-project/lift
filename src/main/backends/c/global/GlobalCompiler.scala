package backends.c.global

import backends.c.common.CCompiler
import backends.c.common.common_cast.CbackendCAST.SourceFile
import backends.c.global.analysis.OclKernelFileNameAnalysis
import backends.c.global.lowering.{GenerateCLockPrintingStmt, GenerateGlobalClockDecl, GenerateOclGlobalFacility}
import backends.c.global.transformation.cast_transformation.cpu_outline_transformation.{CPUOutlineTargetAnalysis, OclOutlineTargetAnalysis}
import backends.c.global.transformation.host_ir_mapper.EmptyKernelStructure
import backends.c.global.transformation.funcall2closure.FunCall2Closure
import backends.c.global.transformation.ocl_memory_gen.OclMemoryGen
import backends.c.global.transformation.purify.Purify
import backends.c.global.transformation.unique_user_func.UniqueUserFunc
import backends.c.host.HostCompiler
import backends.c.host.lowering.LowerIR2HostCAST
...
object GlobalCompiler {
  ...
  def apply(lambda: Lambda, path: String, files: List[String]): Unit = {
