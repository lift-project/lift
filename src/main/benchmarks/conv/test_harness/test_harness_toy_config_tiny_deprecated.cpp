...
//	constexpr int kernel_stride_width = 1;
	...
	constexpr int input_width = 6;
	constexpr int kernel_height = 2;
	constexpr int kernel_width = 3;
	constexpr int num_kernels = 6;

	constexpr int kernel_stride_height = 1;
	constexpr int kernel_stride_width = 1;

//	const int kernelCacheSize = 2;
...
//	lift_global_0 = /*2; */n_tiles_x; //(input_width - kernel_width )/kernel_stride_width + 1;
//	lift_global_1 = /*4; */n_tiles_y; //(input_height - kernel_height)/kernel_stride_height + 1;
