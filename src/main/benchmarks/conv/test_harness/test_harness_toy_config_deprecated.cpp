...
//	lift_global_0 = n_tiles_x;
//	lift_global_1 = n_tiles_y;
...
#ifndef TEST
	copy(output.begin(), output.end(), ostream_iterator<float>(cout << std::setprecision(3), " "));
#else
	copy(output, output + output_length, ostream_iterator<float>(cout << std::setprecision(3), " "));
#endif
